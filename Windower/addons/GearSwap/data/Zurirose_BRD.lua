...
function get_sets()
  ...
  if tanking_in_odyssey then
    sets.midcast["Lullaby"] = set_combine(sets.midcast["Lullaby"], sets.enmity)
    sets.midcast["Horde Lullaby II"] = set_combine(sets.midcast["Horde Lullaby II"], sets.enmity)
    sets.midcast["Magic Finale"] = set_combine(sets.midcast["DebuffSong"], sets.enmity)
  end
