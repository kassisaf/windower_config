return {
  -- 10 minute JA's on 1
  ['Ctrl+1'] = 'input /ja "Blaze of Glory" <me>',
  ['Alt+1']  = 'input /ja "Entrust" <me>',
  -- Physical bubbles
  ['Ctrl+2'] = 'input /ma "Geo-Frailty" <stnpc>',
  ['Alt+2']  = 'input /ma "Indi-Fury" <stpt>',
  ['Ctrl+3'] = 'input /ma "Geo-Torpor" <stnpc>',
  ['Alt+3']  = 'input /ma "Indi-Precision" <stpt>',
  -- Magic bubbles
  ...
  ['Ctrl+7'] = 'input /ma "Geo-Regen" <stpt>',
  ['Alt+7']  = 'input /ma "Indi-Refresh" <stpt>',
  -- Tag
